...
const dictionary: Record<string, RoomDictionary> = {
  ...
  Layout: { fr: "Disposition", tr: "Yerleşim" },
  Detail: { fr: "Détail", tr: "Detay" },
  Desk: { fr: "Bureau", tr: "Çalışma masası" },
  "Traditional interior": { fr: "Intérieur traditionnel", tr: "Geleneksel iç mekân" },
  "Courtyard access": { fr: "Accès à la cour", tr: "Avlu erişimi" },
  "Room layout": { fr: "Agencement de la chambre", tr: "Oda düzeni" },
  "Stone wall interior": { fr: "Intérieur avec mur en pierre", tr: "Taş duvarlı iç mekân" },
  "Stone bathroom details": { fr: "Détails en pierre de la salle de bain", tr: "Taş banyo detayları" },
  "Spacious layout": { fr: "Agencement spacieux", tr: "Geniş yerleşim" },
  "Traditional details": { fr: "Détails traditionnels", tr: "Geleneksel detaylar" },
