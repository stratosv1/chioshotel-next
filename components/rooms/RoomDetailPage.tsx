...
const dictionary: Record<string, RoomDictionary> = {
  ...
  Layout: { fr: "Disposition", it: "Disposizione", tr: "Yerleşim" },
  Detail: { fr: "Détail", it: "Dettaglio", tr: "Detay" },
  Desk: { fr: "Bureau", it: "Scrivania", tr: "Çalışma masası" },
  "Traditional interior": { fr: "Intérieur traditionnel", it: "Interni tradizionali", tr: "Geleneksel iç mekân" },
  "Courtyard access": { fr: "Accès à la cour", it: "Accesso al cortile", tr: "Avlu erişimi" },
  "Room layout": { fr: "Agencement de la chambre", it: "Disposizione della camera", tr: "Oda düzeni" },
  "Stone wall interior": { fr: "Intérieur avec mur en pierre", it: "Interni con parete in pietra", tr: "Taş duvarlı iç mekân" },
  "Stone bathroom details": { fr: "Détails en pierre de la salle de bain", it: "Dettagli in pietra del bagno", tr: "Taş banyo detayları" },
  "Spacious layout": { fr: "Agencement spacieux", it: "Disposizione spaziosa", tr: "Geniş yerleşim" },
  "Traditional details": { fr: "Détails traditionnels", it: "Dettagli tradizionali", tr: "Geleneksel detaylar" },
  "Terrace access": { fr: "Accès à la terrasse", it: "Accesso alla terrazza" },
  "Kitchenette area": { fr: "Espace kitchenette", it: "Area angolo cottura" },
  "Traditional decoration": { fr: "Décoration traditionnelle", it: "Arredi tradizionali" },
