...
function destinationAction(url: URL) {
  ...
  if (value.includes("chios-island") || value.includes("sakiz-adasi/") || value.includes("plaj") || value.includes("köy") || value.includes("koy") || value.includes("kambos")) return "island_guide";
