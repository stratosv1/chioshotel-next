...
function KambosStory({ data }: { data: HomePageData }) {
  ...
  return (
    <section className="px-4 py-7 [contain-intrinsic-size:auto_620px] [content-visibility:auto] md:px-8 md:py-11">
...
function LocationAndDirect({ data }: { data: HomePageData }) {
  return (
    <section className="px-4 py-7 [contain-intrinsic-size:auto_760px] [content-visibility:auto] md:px-8 md:py-11">
      <div className="mx-auto max-w-7xl">
...
function DirectBookingBox({ data }: { data: HomePageData }) {
  ...
  return (
    <section className="px-4 pb-5 pt-1 [contain-intrinsic-size:auto_360px] [content-visibility:auto] md:px-8 md:py-11">
