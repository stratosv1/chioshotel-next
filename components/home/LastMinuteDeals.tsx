...
const ROOM_NAMES: Record<Locale, Copy["rooms"]> = {
  ...
  fr: [
    { id: 1, displayName: "Chambre 1", type: "Chambre Double / Triple à l’étage", location: "Étage" },
    { id: 2, displayName: "Chambre 2", type: "Chambre Double Économique", location: "Étage" },
    { id: 3, displayName: "Chambre 3", type: "Chambre Double / Triple à l’étage", location: "Étage" },
    { id: 4, displayName: "Chambre 4", type: "Chambre Double / Triple à l’étage", location: "Étage" },
    { id: 5, displayName: "Chambre 5", type: "Chambre Double / Triple au rez-de-chaussée", location: "Rez-de-chaussée" },
    { id: 6, displayName: "Chambre 6", type: "Chambre Double Économique", location: "Rez-de-chaussée" },
    { id: 7, displayName: "Chambre 7", type: "Chambre Double / Triple au rez-de-chaussée", location: "Rez-de-chaussée" },
    { id: 8, displayName: "Appartement 8", type: "Appartement", location: "Indépendant" },
    { id: 9, displayName: "Appartement 9", type: "Appartement", location: "Indépendant" },
    { id: 10, displayName: "Appartement 10", type: "Appartement", location: "Indépendant" },
  ],
  de: [
