...
const badgeCopy: Record<LanguageCode, Record<TopicBadgeKey, TopicBadgeCopy>> = {
  en: {
    ...
    airportStay: { emoji: "✈️", label: "Near Chios airport", itemId: "contact" },
  ...
  el: {
    ...
    airportStay: { emoji: "✈️", label: "Κοντά στο αεροδρόμιο Χίου", itemId: "contact" },
  ...
  fr: {
    ...
    airportStay: { emoji: "✈️", label: "Près de l’aéroport de Chios", itemId: "contact" },
  ...
  de: {
    ...
    airportStay: { emoji: "✈️", label: "Nahe Flughafen Chios", itemId: "contact" },
  ...
  it: {
    ...
    airportStay: { emoji: "✈️", label: "Vicino all’aeroporto di Chios", itemId: "contact" },
  ...
  es: {
    ...
    airportStay: { emoji: "✈️", label: "Cerca del aeropuerto de Quíos", itemId: "contact" },
  ...
  tr: {
    ...
    airportStay: { emoji: "✈️", label: "Sakız Havalimanı’na yakın", itemId: "contact" },
