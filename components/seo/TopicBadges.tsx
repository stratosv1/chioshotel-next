...
const badgeCopy: Record<LanguageCode, Record<TopicBadgeKey, TopicBadgeCopy>> = {
  en: {
    ...
    airportStay: { emoji: "🚗", label: "8 km from Chios town", itemId: "contact" },
  ...
  el: {
    ...
    airportStay: { emoji: "🚗", label: "8 χλμ. από την πόλη της Χίου", itemId: "contact" },
  ...
  fr: {
    ...
    airportStay: { emoji: "🚗", label: "À 8 km de la ville de Chios", itemId: "contact" },
  ...
  de: {
    ...
    airportStay: { emoji: "🚗", label: "8 km von Chios-Stadt", itemId: "contact" },
  ...
  it: {
    ...
    airportStay: { emoji: "🚗", label: "8 km dalla città di Chios", itemId: "contact" },
  ...
  es: {
    ...
    airportStay: { emoji: "🚗", label: "A 8 km de la ciudad de Quíos", itemId: "contact" },
  ...
  tr: {
    ...
    airportStay: { emoji: "🚗", label: "Sakız şehir merkezine 8 km", itemId: "contact" },
