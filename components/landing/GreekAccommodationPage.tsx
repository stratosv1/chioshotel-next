...
function SwipeHint() {
  return (
    <p className="mt-5 text-center text-[10px] font-black uppercase tracking-[0.15em] text-amber-800 md:hidden">
      Σύρετε για περισσότερα <span aria-hidden="true">→</span>
    </p>
  );
}
...
export function GreekAccommodationPage({ data }: Props) {
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#fbf6ef] text-[#2f261f]">
      <section
        ...
        aria-labelledby="diamoni-sti-xio-title"
      >
          ...
          <div className="flex flex-col justify-center px-4 py-10 sm:px-6 sm:py-14 lg:px-8 lg:py-24">
            ...
            <div className="mt-7 grid grid-cols-2 gap-3 sm:mt-8 sm:flex sm:flex-wrap">
              ...
              <a
                ...
                className="col-span-2 inline-flex min-h-12 items-center justify-center rounded-full border border-amber-200/35 px-5 py-3 text-center text-xs font-black uppercase tracking-[0.08em] !text-amber-100 transition hover:-translate-y-0.5 hover:bg-amber-100 hover:!text-[#2f261f] focus:outline-none focus:ring-4 focus:ring-amber-200/30 sm:col-span-1"
              >
          ...
          <div className="relative min-h-[300px] sm:min-h-[380px] lg:min-h-full">
            ...
            <div className="absolute bottom-4 left-4 right-4 rounded-[22px] border border-white/20 bg-[#263127]/72 p-4 shadow-2xl backdrop-blur-md sm:bottom-8 sm:left-8 sm:right-8 sm:rounded-[26px] sm:p-6">
              <p className="text-[9px] font-black uppercase tracking-[0.18em] text-amber-200 sm:text-[10px] sm:tracking-[0.2em]">
                Voulamandis House • Χίος
              </p>
              <p className="mt-2 text-lg font-black tracking-[-0.025em] text-white sm:text-2xl">
                Δωμάτια και διαμερίσματα στο ιστορικό τοπίο του Κάμπου
              </p>
            </div>
          </div>
        </div>
      ...
      <section
        ...
        aria-label="Βασικές πληροφορίες διαμονής"
      >
        <div className="mx-auto flex max-w-7xl snap-x snap-mandatory overflow-x-auto bg-amber-900/10 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden lg:grid lg:grid-cols-6 lg:gap-px lg:overflow-visible">
          {data.highlights.map((item) => (
            ...
            >
              <p className="text-[9px] font-black uppercase tracking-[0.14em] text-amber-800 sm:text-[10px] sm:tracking-[0.16em]">
                {item.label}
              </p>
      ...
      <section
        ...
        aria-labelledby="diamoni-domatia-title"
      >
              ...
              >
                <article className="grid h-full sm:grid-cols-[0.9fr_1.1fr]">
                  ...
                  <div className="flex flex-col p-5 sm:p-7">
                    <p className="text-[9px] font-black uppercase tracking-[0.15em] text-amber-800 sm:text-[10px] sm:tracking-[0.17em]">
                      {card.eyebrow}
                    </p>
                    ...
                    <div className="mt-4 flex flex-wrap gap-2 sm:mt-5">
                      {card.facts.map((fact) => (
                        <span
                          key={fact}
                          className="rounded-full bg-amber-50 px-2.5 py-1.5 text-[9px] font-black uppercase tracking-[0.04em] text-amber-900 ring-1 ring-amber-900/10 sm:px-3 sm:text-[10px]"
                        >
                          {fact}
                        </span>
                      ))}
                    </div>
                    <span className="mt-5 inline-flex items-center gap-2 text-[11px] font-black uppercase tracking-[0.08em] text-amber-800 sm:mt-6 sm:text-xs">
                      Δείτε την επιλογή <span aria-hidden="true">→</span>
                    </span>
                  </div>
                </article>
              </a>
      ...
      <section
        className="px-4 py-11 sm:px-6 sm:py-14 lg:px-8 lg:py-24"
        aria-labelledby="diamoni-kampos-title"
      >
          ...
          <div className="p-5 sm:p-9 lg:p-12">
            ...
            <div className="-mx-1 mt-6 flex snap-x snap-mandatory gap-3 overflow-x-auto px-1 pb-2 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:mx-0 sm:mt-8 sm:grid sm:grid-cols-3 sm:overflow-visible sm:px-0 sm:pb-0">
              {data.location.distances.map((item) => (
                ...
                >
                  <p className="text-[9px] font-black uppercase tracking-[0.11em] text-amber-200 sm:text-[10px]">
                    {item.label}
                  </p>
      ...
      <section
        ...
        aria-labelledby="diamoni-paroxes-title"
      >
        <div className="mx-auto max-w-7xl">
          <SectionHeader
      ...
      <section
        className="bg-[#f1e7d8] px-4 py-11 sm:px-6 sm:py-14 lg:px-8 lg:py-24"
        aria-labelledby="diamoni-gia-poious-title"
      >
        <div className="mx-auto max-w-7xl">
          <SectionHeader
            eyebrow={data.travelerTypes.kicker}
            title={data.travelerTypes.title}
            id="diamoni-gia-poious-title"
          />
          <SwipeHint />
      ...
      <section
        className="px-4 py-11 sm:px-6 sm:py-14 lg:px-8 lg:py-24"
        aria-labelledby="diamoni-kratisi-title"
      >
        <div className="mx-auto grid max-w-7xl items-start gap-6 rounded-[30px] bg-[#fffdfa] p-5 shadow-[0_26px_80px_rgba(47,38,31,0.12)] ring-1 ring-amber-900/10 sm:gap-8 sm:rounded-[38px] sm:p-9 lg:grid-cols-[1.1fr_0.9fr] lg:p-12">
          <div>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:mt-8 sm:flex sm:flex-wrap">
              ...
              <a
                ...
                className="inline-flex min-h-12 items-center justify-center rounded-full border border-amber-900/15 bg-amber-50 px-4 py-3 text-center text-[11px] font-black uppercase tracking-[0.06em] !text-amber-900 transition hover:-translate-y-0.5 hover:bg-amber-100 focus:outline-none focus:ring-4 focus:ring-amber-700/15 sm:px-5 sm:text-xs"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="col-span-2 inline-flex min-h-12 items-center justify-center rounded-full border border-emerald-800/15 bg-emerald-50 px-5 py-3 text-center text-xs font-black uppercase tracking-[0.07em] !text-emerald-900 transition hover:-translate-y-0.5 hover:bg-emerald-100 focus:outline-none focus:ring-4 focus:ring-emerald-700/15 sm:col-span-1"
              >
          ...
          <aside className="h-fit self-start rounded-[26px] bg-[#263127] p-5 text-white sm:rounded-[30px] sm:p-8">
            <p className="text-[10px] font-black uppercase tracking-[0.18em] text-amber-200 sm:text-[11px] sm:tracking-[0.21em]">
              Πλεονεκτήματα απευθείας κράτησης
            </p>
            <ul className="mt-5 grid gap-3 sm:mt-6 sm:gap-4">
      ...
      <section
        className="bg-white px-4 py-11 sm:px-6 sm:py-14 lg:px-8 lg:py-24"
        aria-labelledby="diamoni-explore-title"
      >
        <div className="mx-auto max-w-7xl">
          <SectionHeader
          ...
          <div className={`${mobileCarousel} mt-7 md:grid-cols-2 md:gap-4 lg:grid-cols-4 sm:mt-10`}>
            {data.explore.links.map((link) => (
              ...
              >
                ...
                <span className="mt-4 inline-flex text-[11px] font-black uppercase tracking-[0.08em] text-amber-800 sm:mt-5 sm:text-xs">
                  Ανακαλύψτε <span className="ml-2 transition group-hover:translate-x-1" aria-hidden="true">→</span>
                </span>
              </a>
            ))}
          </div>
      ...
      <section
        className="bg-[#f1e7d8] px-4 py-11 sm:px-6 sm:py-14 lg:px-8 lg:py-24"
        aria-labelledby="diamoni-faq-title"
      >
        <div className="mx-auto max-w-4xl">
          <SectionHeader
            eyebrow={data.faq.kicker}
            title={data.faq.title}
            id="diamoni-faq-title"
          />
      ...
      <section
        ...
        aria-labelledby="diamoni-final-title"
      >
