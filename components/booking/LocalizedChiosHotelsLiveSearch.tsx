...
type FeatureKey = "upperFloor" | "groundFloor" | "privateBalcony" | "sharedTerrace" | "doubleBed" | "kitchenette" | "noStairs" | "gardenAccess" | "fullKitchen" | "livingArea" | "familyLayout" | "upTo2" | "upTo3" | "upTo4" | "upTo5";

const FEATURE_COPY: Record<ChiosHotelsGuideLocale, Record<FeatureKey, string>> = {
  en: { upperFloor: "Upper floor", groundFloor: "Ground floor", privateBalcony: "Private balcony", sharedTerrace: "Shared terrace", doubleBed: "Double bed", kitchenette: "Kitchenette", noStairs: "Step-free access", gardenAccess: "Garden access", fullKitchen: "Full kitchen", livingArea: "Living area", familyLayout: "Family layout", upTo2: "2 guests", upTo3: "Up to 3 guests", upTo4: "Up to 4 guests", upTo5: "4 guests; 5th by arrangement" },
  el: { upperFloor: "Επάνω όροφος", groundFloor: "Ισόγειο", privateBalcony: "Ιδιωτικό μπαλκόνι", sharedTerrace: "Κοινόχρηστη βεράντα", doubleBed: "Διπλό κρεβάτι", kitchenette: "Μικρή κουζίνα", noStairs: "Χωρίς σκαλοπάτια", gardenAccess: "Πρόσβαση στον κήπο", fullKitchen: "Πλήρης κουζίνα", livingArea: "Καθιστικό", familyLayout: "Οικογενειακή διάταξη", upTo2: "2 επισκέπτες", upTo3: "Έως 3 επισκέπτες", upTo4: "Έως 4 επισκέπτες", upTo5: "4 άτομα· 5ο κατόπιν συνεννόησης" },
  fr: { upperFloor: "À l’étage", groundFloor: "Rez-de-chaussée", privateBalcony: "Balcon privé", sharedTerrace: "Terrasse commune", doubleBed: "Lit double", kitchenette: "Kitchenette", noStairs: "Accès sans marches", gardenAccess: "Accès jardin", fullKitchen: "Cuisine complète", livingArea: "Espace salon", familyLayout: "Configuration familiale", upTo2: "2 personnes", upTo3: "Jusqu’à 3 personnes", upTo4: "Jusqu’à 4 personnes", upTo5: "4 personnes ; 5e sur accord" },
  de: { upperFloor: "Obergeschoss", groundFloor: "Erdgeschoss", privateBalcony: "Privatbalkon", sharedTerrace: "Gemeinschaftsterrasse", doubleBed: "Doppelbett", kitchenette: "Küchenzeile", noStairs: "Stufenloser Zugang", gardenAccess: "Gartenzugang", fullKitchen: "Vollständige Küche", livingArea: "Wohnbereich", familyLayout: "Familienaufteilung", upTo2: "2 Gäste", upTo3: "Bis 3 Gäste", upTo4: "Bis 4 Gäste", upTo5: "4 Gäste; 5. nach Absprache" },
  it: { upperFloor: "Piano superiore", groundFloor: "Piano terra", privateBalcony: "Balcone privato", sharedTerrace: "Terrazza comune", doubleBed: "Letto matrimoniale", kitchenette: "Angolo cottura", noStairs: "Accesso senza gradini", gardenAccess: "Accesso al giardino", fullKitchen: "Cucina completa", livingArea: "Zona giorno", familyLayout: "Disposizione familiare", upTo2: "2 ospiti", upTo3: "Fino a 3 ospiti", upTo4: "Fino a 4 ospiti", upTo5: "4 ospiti; 5º previo accordo" },
  es: { upperFloor: "Planta superior", groundFloor: "Planta baja", privateBalcony: "Balcón privado", sharedTerrace: "Terraza común", doubleBed: "Cama doble", kitchenette: "Zona de cocina", noStairs: "Acceso sin escalones", gardenAccess: "Acceso al jardín", fullKitchen: "Cocina completa", livingArea: "Zona de estar", familyLayout: "Distribución familiar", upTo2: "2 huéspedes", upTo3: "Hasta 3 huéspedes", upTo4: "Hasta 4 huéspedes", upTo5: "4 huéspedes; 5º previo acuerdo" },
  tr: { upperFloor: "Üst kat", groundFloor: "Zemin kat", privateBalcony: "Özel balkon", sharedTerrace: "Ortak teras", doubleBed: "Çift kişilik yatak", kitchenette: "Mini mutfak", noStairs: "Basamaksız erişim", gardenAccess: "Bahçe erişimi", fullKitchen: "Tam mutfak", livingArea: "Oturma alanı", familyLayout: "Aile düzeni", upTo2: "2 misafir", upTo3: "3 misafire kadar", upTo4: "4 misafire kadar", upTo5: "4 kişi; 5. kişi anlaşmayla" },
};
...
const ROOM_META: Record<number, { kind: "upper" | "ground" | "economy" | "apartment"; route: "standard" | "economy" | "family"; image: string; features: FeatureKey[]; large?: boolean }> = {
  ...
  8: { kind: "apartment", route: "family", image: "/images/rooms/chios-apartments-voulamandis.webp", features: ["fullKitchen", "noStairs", "upTo4"] },
  9: { kind: "apartment", route: "family", image: "/images/rooms/chios-apartments-voulamandis.webp", features: ["fullKitchen", "noStairs", "upTo4"] },
  10: { kind: "apartment", route: "family", image: "/images/rooms/DSC07899.webp", features: ["fullKitchen", "noStairs", "upTo5"], large: true },
};
