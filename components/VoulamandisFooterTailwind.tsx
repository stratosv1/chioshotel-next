...
const footerCopy: Record<LanguageCode, FooterCopy> = {
  en: {
    description: "Quiet rooms and apartments in the historic Kampos area of Chios, with easy access to Chios Town, the airport, beaches, villages and cultural landmarks.",
    bookStay: "Book your stay",
    whatsapp: "WhatsApp",
    allRightsReserved: "All rights reserved.",
    groups: { stay: "Stay", exploreChios: "Explore Chios", popularGuides: "Popular Guides" },
    links: { rooms: "Rooms", ratesAvailability: "Rates & Availability", contact: "Contact", chiosIslandGuide: "Chios Island Guide", beaches: "Chios Beaches", villages: "Chios Villages", museums: "Chios Museums", holidayQuiz: "Chios Holiday Quiz", agiaDynami: "Agia Dynami Beach", mavraVolia: "Mavra Volia Beach", pyrgi: "Pyrgi Village", mesta: "Mesta Village", masticMuseum: "Chios Mastic Museum" },
  },
  el: {
    description: "Ήσυχα δωμάτια και διαμερίσματα στον ιστορικό Κάμπο της Χίου, με εύκολη πρόσβαση στην πόλη, το αεροδρόμιο, τις παραλίες, τα χωριά και τα αξιοθέατα.",
    bookStay: "Κάντε κράτηση",
    whatsapp: "WhatsApp",
    allRightsReserved: "Με επιφύλαξη παντός δικαιώματος.",
    groups: { stay: "Διαμονή", exploreChios: "Ανακαλύψτε τη Χίο", popularGuides: "Δημοφιλείς οδηγοί" },
    links: { rooms: "Δωμάτια", ratesAvailability: "Τιμές & Διαθεσιμότητα", contact: "Επικοινωνία", chiosIslandGuide: "Οδηγός Χίου", beaches: "Παραλίες της Χίου", villages: "Χωριά της Χίου", museums: "Μουσεία της Χίου", holidayQuiz: "Quiz διακοπών στη Χίο", agiaDynami: "Παραλία Αγία Δύναμη", mavraVolia: "Παραλία Μαύρα Βόλια", pyrgi: "Χωριό Πυργί", mesta: "Χωριό Μεστά", masticMuseum: "Μουσείο Μαστίχας Χίου" },
  },
  fr: {
    description: "Chambres et appartements calmes dans le quartier historique de Kampos à Chios, avec un accès facile à la ville, à l’aéroport, aux plages, aux villages et aux sites culturels.",
    bookStay: "Réserver votre séjour",
    whatsapp: "WhatsApp",
    allRightsReserved: "Tous droits réservés.",
    groups: { stay: "Séjour", exploreChios: "Explorer Chios", popularGuides: "Guides populaires" },
    links: { rooms: "Chambres", ratesAvailability: "Tarifs & Disponibilité", contact: "Contact", chiosIslandGuide: "Guide de Chios", beaches: "Plages de Chios", villages: "Villages de Chios", museums: "Musées de Chios", holidayQuiz: "Quiz vacances à Chios", agiaDynami: "Plage d’Agia Dynami", mavraVolia: "Plage de Mavra Volia", pyrgi: "Village de Pyrgi", mesta: "Village de Mesta", masticMuseum: "Musée du Mastic de Chios" },
  },
  de: {
    description: "Ruhige Zimmer und Apartments im historischen Kampos-Gebiet von Chios, mit einfachem Zugang zur Stadt, zum Flughafen, zu Stränden, Dörfern und Sehenswürdigkeiten.",
    bookStay: "Aufenthalt buchen",
    whatsapp: "WhatsApp",
    allRightsReserved: "Alle Rechte vorbehalten.",
    groups: { stay: "Aufenthalt", exploreChios: "Chios entdecken", popularGuides: "Beliebte Reiseführer" },
    links: { rooms: "Zimmer", ratesAvailability: "Preise & Verfügbarkeit", contact: "Kontakt", chiosIslandGuide: "Chios Reiseführer", beaches: "Strände auf Chios", villages: "Dörfer auf Chios", museums: "Museen auf Chios", holidayQuiz: "Chios Urlaubsquiz", agiaDynami: "Agia Dynami Strand", mavraVolia: "Mavra Volia Strand", pyrgi: "Pyrgi Dorf", mesta: "Mesta Dorf", masticMuseum: "Chios Mastix Museum" },
  },
  it: {
    description: "Camere e appartamenti tranquilli nella storica zona di Kampos a Chios, con facile accesso alla città, all’aeroporto, alle spiagge, ai villaggi e ai luoghi culturali.",
    bookStay: "Prenota il soggiorno",
    whatsapp: "WhatsApp",
    allRightsReserved: "Tutti i diritti riservati.",
    groups: { stay: "Soggiorno", exploreChios: "Esplora Chios", popularGuides: "Guide popolari" },
    links: { rooms: "Camere", ratesAvailability: "Prezzi & Disponibilità", contact: "Contatti", chiosIslandGuide: "Guida di Chios", beaches: "Spiagge di Chios", villages: "Villaggi di Chios", museums: "Musei di Chios", holidayQuiz: "Quiz vacanze a Chios", agiaDynami: "Spiaggia di Agia Dynami", mavraVolia: "Spiaggia di Mavra Volia", pyrgi: "Villaggio di Pyrgi", mesta: "Villaggio di Mesta", masticMuseum: "Museo del Mastice di Chios" },
  },
  es: {
    description: "Habitaciones y apartamentos tranquilos en la histórica zona de Kampos en Chios, con fácil acceso a la ciudad, al aeropuerto, a playas, pueblos y lugares culturales.",
    bookStay: "Reserva tu estancia",
    whatsapp: "WhatsApp",
    allRightsReserved: "Todos los derechos reservados.",
    groups: { stay: "Estancia", exploreChios: "Explorar Chios", popularGuides: "Guías populares" },
    links: { rooms: "Habitaciones", ratesAvailability: "Precios & Disponibilidad", contact: "Contacto", chiosIslandGuide: "Guía de Chios", beaches: "Playas de Chios", villages: "Pueblos de Chios", museums: "Museos de Chios", holidayQuiz: "Quiz de vacaciones en Chios", agiaDynami: "Playa Agia Dynami", mavraVolia: "Playa Mavra Volia", pyrgi: "Pueblo de Pyrgi", mesta: "Pueblo de Mesta", masticMuseum: "Museo del Mastiha de Chios" },
  },
  tr: {
    description: "Sakız Adası’nın tarihi Kampos bölgesinde, şehir merkezine, havaalanına, plajlara, köylere ve kültürel noktalara kolay erişimli sakin odalar ve daireler.",
    bookStay: "Konaklamanızı ayırtın",
    whatsapp: "WhatsApp",
    allRightsReserved: "Tüm hakları saklıdır.",
    groups: { stay: "Konaklama", exploreChios: "Sakız Adası’nı keşfedin", popularGuides: "Popüler rehberler" },
...
export function VoulamandisFooterTailwind({ language = "en" }: FooterProps) {
  ...
  const groups = [
    { title: copy.groups.stay, links: [
      { label: copy.links.rooms, href: roomsPaths[language] },
      { label: copy.links.ratesAvailability, href: ratesPaths[language] },
      { label: copy.links.contact, href: contactPaths[language] },
    ] },
    { title: copy.groups.exploreChios, links: [
      { label: copy.links.chiosIslandGuide, href: chiosPaths[language] },
      { label: copy.links.beaches, href: beachPaths[language] },
      { label: copy.links.villages, href: villagePaths[language] },
      { label: copy.links.museums, href: museumPaths[language] },
      { label: copy.links.holidayQuiz, href: quizPaths[language] },
    ] },
    { title: copy.groups.popularGuides, links: [
      { label: copy.links.agiaDynami, href: agiaDynamiPaths[language] },
      { label: copy.links.mavraVolia, href: mavraVoliaPaths[language] },
      { label: copy.links.pyrgi, href: pyrgiPaths[language] },
      { label: copy.links.mesta, href: mestaPaths[language] },
      { label: copy.links.masticMuseum, href: masticMuseumPaths[language] },
    ] },
  ];
  ...
  return (
    <footer className="relative overflow-hidden bg-stone-950 pb-24 text-white md:pb-0">
      ...
      <div className="relative mx-auto grid max-w-7xl gap-4 px-4 py-7 sm:px-6 md:gap-10 md:py-14 lg:grid-cols-[0.92fr_1.65fr] lg:px-8 lg:py-20">
        <section className="rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-4 shadow-xl shadow-black/15 backdrop-blur md:rounded-[2rem] md:p-8 md:shadow-2xl">
          ...
          <div className="mt-4 grid grid-cols-4 gap-2 md:mt-7 md:grid-cols-2 lg:flex lg:flex-wrap">
            <a href={ratesPaths[language]} aria-label={copy.bookStay} className="inline-flex min-h-10 items-center justify-center rounded-full bg-white px-3 text-[0px] font-black uppercase tracking-[0.1em] text-stone-900 shadow-lg shadow-black/10 md:text-[11px] lg:px-5"><span className="text-base md:hidden">📅</span><span className="hidden md:inline">{copy.bookStay}</span></a>
            <a href="https://wa.me/306944474226" target="_blank" rel="noopener" aria-label={copy.whatsapp} className="inline-flex min-h-10 items-center justify-center rounded-full border border-white/15 bg-white/10 px-3 text-[0px] font-black uppercase tracking-[0.1em] text-white md:text-[11px] lg:px-5"><span className="text-base md:hidden">💬</span><span className="hidden md:inline">{copy.whatsapp}</span></a>
            <a href="https://www.instagram.com/chioshotels/" target="_blank" rel="noopener" aria-label="Instagram" className="inline-flex min-h-10 items-center justify-center rounded-full border border-white/15 bg-white/10 px-3 text-[0px] font-black uppercase tracking-[0.1em] text-white md:text-[11px] lg:px-5"><span className="text-base md:hidden">◎</span><span className="hidden md:inline">Instagram</span></a>
            <a href="https://www.facebook.com/people/Voulamandis-House/100063584320703/" target="_blank" rel="noopener" aria-label="Facebook" className="inline-flex min-h-10 items-center justify-center rounded-full border border-white/15 bg-white/10 px-3 text-[0px] font-black uppercase tracking-[0.1em] text-white md:text-[11px] lg:px-5"><span className="text-base md:hidden">f</span><span className="hidden md:inline">Facebook</span></a>
          </div>
        </section>
              ...
              <ul className="mt-3 grid grid-cols-1 gap-1.5 md:mt-5 md:gap-3">
                {group.links.map((link) => (
                  <li key={`${group.title}-${link.href}`}>
                    <a href={link.href} className="group flex min-h-9 items-center justify-between rounded-2xl bg-white/[0.04] px-3 py-2 text-[12px] font-bold text-white/75 ring-1 ring-white/5 transition hover:bg-white/10 hover:text-white md:bg-transparent md:text-sm md:ring-0">
      ...
      <div className="relative border-t border-white/10 px-4 py-4 md:py-5">
        <div className="mx-auto flex max-w-7xl flex-col gap-2 text-[10px] font-bold uppercase tracking-[0.1em] text-white/42 sm:flex-row sm:items-center sm:justify-between md:text-xs md:tracking-[0.12em]"><p>© {year} Voulamandis House. {copy.allRightsReserved}</p><p>Chios rooms & apartments · Direct stay</p></div>
      </div>
    </footer>
  );
}
