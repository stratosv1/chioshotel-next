      ...
      <div className="relative mx-auto grid max-w-7xl gap-4 px-4 py-7 sm:px-6 md:gap-10 md:py-14 lg:grid-cols-[0.92fr_1.65fr] lg:px-8 lg:py-20">
        <section className="rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-4 shadow-xl shadow-black/15 backdrop-blur md:rounded-[2rem] md:p-8 md:shadow-2xl">
          ...
          <div className="mt-4 grid grid-cols-4 gap-2 md:mt-7 md:grid-cols-2 lg:flex lg:flex-wrap">
            ...
            <a href="https://wa.me/306944474226" target="_blank" rel="noopener" aria-label={copy.whatsapp} className="inline-flex min-h-10 items-center justify-center rounded-full bg-[#25D366] px-3 text-[0px] font-black uppercase tracking-[0.1em] text-white shadow-lg shadow-[#25D366]/25 transition hover:bg-[#1ebe5d] md:text-[11px] lg:px-5"><span className="text-base md:hidden">💬</span><span className="hidden md:inline">{copy.whatsapp}</span></a>
