...
const footerCopy: Record<LanguageCode, FooterCopy> = {
  en: { description: "Quiet rooms and apartments in the historic Kampos area of Chios, with easy access to Chios Town, the airport, beaches, villages and cultural landmarks.", bookStay: "Book", whatsapp: "WhatsApp", allRightsReserved: "All rights reserved.", groups: { stay: "Stay", exploreChios: "Explore Chios", popularGuides: "Popular Guides" }, links: { rooms: "Rooms", ratesAvailability: "Rates & Availability", contact: "Contact", faq: "Frequently Asked Questions", chiosIslandGuide: "Chios Island Guide", beaches: "Chios Beaches", villages: "Chios Villages", museums: "Chios Museums", holidayQuiz: "Chios Holiday Quiz", agiaDynami: "Agia Dynami Beach", mavraVolia: "Mavra Volia Beach", pyrgi: "Pyrgi Village", mesta: "Mesta Village", masticMuseum: "Chios Mastic Museum" } },
...
const museumPaths: Record<LanguageCode, string> = { en: "/chios/chios-museums/", el: "/el/mouseia-xios/", fr: "/fr/musees-de-chios/", de: "/de/museen-chios/", it: "/it/spiagge-chios/", es: "/es/museos-chios/", tr: "/tr/sakiz-adasi-muzeleri/" };
