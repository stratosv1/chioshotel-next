...
const findYourRoomPaths: Record<LanguageCode, string> = {
  en: "/find-your-room/",
...
const beachDetailPathGroups: Record<LanguageCode, string>[] = [
  ...
  {
    en: "/chios/chios-beaches/kato-fana-beach/",
    el: "/el/paralies-xios/paralia-kato-fana/",
    fr: "/fr/plages-de-chios/plage-kato-fana/",
    de: "/de/straende-chios/kato-fana-strand/",
    it: "/it/spiagge-chios/spiaggia-kato-fana/",
    es: "/es/playas-chios/playa-kato-fana/",
    tr: "/tr/sakiz-adasi-plajlari/kato-fana-plaji/",
  },
  {
    en: "/chios/chios-beaches/vroulidia-beach/",
    el: "/el/paralies-xios/paralia-vroulidia/",
    fr: "/fr/plages-de-chios/plage-vroulidia/",
    de: "/de/straende-chios/vroulidia-strand/",
    it: "/it/spiagge-chios/spiaggia-vroulidia/",
    es: "/es/playas-chios/playa-vroulidia/",
    tr: "/tr/sakiz-adasi-plajlari/vroulidia-plaji/",
  },
  {
...
> = {
  ...
  el: {
    ariaMain: "ΞΟΟΞΉΞ± Ο€Ξ»ΞΏΞ®Ξ³Ξ·ΟƒΞ·",
    ariaLanguage: "Ξ•Ο€ΞΉΞ»ΞΏΞ³Ξ® Ξ³Ξ»ΟΟƒΟƒΞ±Ο‚",
    bookNow: "ΞΟΞ¬Ο„Ξ·ΟƒΞ·",
    bookStay: "ΞΞ¬Ξ½Ο„Ξµ ΞΊΟΞ¬Ο„Ξ·ΟƒΞ·",
    menu: "ΞΞµΞ½ΞΏΟ",
    exploreTitle: "Ξ‘Ξ½Ξ±ΞΊΞ±Ξ»ΟΟΟ„Ξµ Ο„ΞΏ Voulamandis House",
    language: "Ξ“Ξ»ΟΟƒΟƒΞ±",
    stay: "Ξ”ΞΉΞ±ΞΌΞΏΞ½Ξ®",
    exploreChios: "Ξ‘Ξ½Ξ±ΞΊΞ±Ξ»ΟΟΟ„Ξµ Ο„Ξ· Ξ§Ξ―ΞΏ",
    closeMenu: "ΞΞ»ΞµΞ―ΟƒΞΉΞΌΞΏ ΞΌΞµΞ½ΞΏΟ",
    openMenu: "Ξ†Ξ½ΞΏΞΉΞ³ΞΌΞ± ΞΌΞµΞ½ΞΏΟ",
    rooms: "Ξ”Ο‰ΞΌΞ¬Ο„ΞΉΞ±",
    findYourRoom: "Ξ’ΟΞµΟ‚ Ο„ΞΏ Ξ΄Ο‰ΞΌΞ¬Ο„ΞΉΟ ΟƒΞΏΟ…",
    rates: "Ξ¤ΞΉΞΌΞ­Ο‚",
    ratesAvailability: "Ξ¤ΞΉΞΌΞ­Ο‚ & Ξ”ΞΉΞ±ΞΈΞµΟƒΞΉΞΌΟΟ„Ξ·Ο„Ξ±",
    deals: "Ξ ΟΞΏΟƒΟ†ΞΏΟΞ­Ο‚",
    chiosIsland: "Ξ§Ξ―ΞΏΟ‚",
    beaches: "Ξ Ξ±ΟΞ±Ξ»Ξ―ΞµΟ‚",
    villages: "Ξ§Ο‰ΟΞΉΞ¬",
    museums: "ΞΞΏΟ…ΟƒΞµΞ―Ξ±",
    chiosActivities: "Ξ”ΟΞ±ΟƒΟ„Ξ·ΟΞΉΟΟ„Ξ·Ο„ΞµΟ‚ ΟƒΟ„Ξ· Ξ§Ξ―ΞΏ",
    contact: "Ξ•Ο€ΞΉΞΊΞΏΞΉΞ½Ο‰Ξ½Ξ―Ξ±",
    chiosIslandGuide: "ΞΞ΄Ξ·Ξ³ΟΟ‚ Ξ§Ξ―ΞΏΟ…",
    live: "Live",
    exploreCards: {
      beaches: {
        title: "Ξ Ξ±ΟΞ±Ξ»Ξ―ΞµΟ‚ Ο„Ξ·Ο‚ Ξ§Ξ―ΞΏΟ…",
        text: "ΞΞ±ΞΈΞ±ΟΞ¬ Ξ½ΞµΟΞ¬, ΟΞΌΞΏΟΟ†ΞΏΞΉ ΟΟΞΌΞΏΞΉ ΞΊΞ±ΞΉ Ο€Ξ±ΟΞ±Ξ»Ξ―ΞµΟ‚ Ξ³ΞΉΞ± ΞΊΞ¬ΞΈΞµ Ο„Ξ±ΞΎΞΉΞ΄ΞΉΟΟ„Ξ·.",
      },
      villages: {
        title: "Ξ§Ο‰ΟΞΉΞ¬ Ο„Ξ·Ο‚ Ξ§Ξ―ΞΏΟ…",
        text: "ΞΞ±ΟƒΟ„ΞΉΟ‡ΞΏΟ‡ΟΟΞΉΞ±, ΞΌΞµΟƒΞ±ΞΉΟ‰Ξ½ΞΉΞΊΞ¬ ΟƒΞΏΞΊΞ¬ΞΊΞΉΞ± ΞΊΞ±ΞΉ Ξ±Ο…ΞΈΞµΞ½Ο„ΞΉΞΊΞ® Ο„ΞΏΟ€ΞΉΞΊΞ® Ξ¶Ο‰Ξ®.",
      },
      museums: {
        title: "ΞΞΏΟ…ΟƒΞµΞ―Ξ± Ο„Ξ·Ο‚ Ξ§Ξ―ΞΏΟ…",
        text: "ΞΞ±ΟƒΟ„Ξ―Ο‡Ξ±, ΞΉΟƒΟ„ΞΏΟΞ―Ξ±, Ξ²ΞΉΞ²Ξ»Ξ―Ξ± ΞΊΞ±ΞΉ Ξ½Ξ±Ο…Ο„ΞΉΞΊΞ® Ο€Ξ±ΟΞ¬Ξ΄ΞΏΟƒΞ·.",
      },
    },
  },
  fr: {
    ariaMain: "Navigation principale",
    ariaLanguage: "SΓ©lecteur de langue",
    bookNow: "RΓ©server",
    bookStay: "RΓ©server votre sΓ©jour",
    menu: "Menu",
    exploreTitle: "DΓ©couvrez Voulamandis House",
    language: "Langue",
    stay: "SΓ©jour",
    ...
    rooms: "Chambres",
    findYourRoom: "Trouvez votre chambre",
    rates: "Tarifs",
    ratesAvailability: "Tarifs & DisponibilitΓ©",
    deals: "Offres",
    chiosIsland: "Γle de Chios",
    beaches: "Plages",
    villages: "Villages",
    museums: "MusΓ©es",
    chiosActivities: "ActivitΓ©s Γ  Chios",
    contact: "Contact",
    ...
    exploreCards: {
      ...
      villages: {
        ...
        text: "Villages du mastic, ruelles mΓ©diΓ©vales et vie locale.",
      },
      museums: {
        title: "MusΓ©es de Chios",
  ...
  de: {
    ...
    closeMenu: "MenΓΌ schlieΓen",
    openMenu: "MenΓΌ Γ¶ffnen",
    rooms: "Zimmer",
    findYourRoom: "Finde dein Zimmer",
    rates: "Preise",
    ratesAvailability: "Preise & VerfΓΌgbarkeit",
    deals: "Angebote",
    chiosIsland: "Insel Chios",
    beaches: "StrΓ¤nde",
    villages: "DΓ¶rfer",
    museums: "Museen",
    chiosActivities: "AktivitΓ¤ten auf Chios",
    contact: "Kontakt",
    chiosIslandGuide: "Chios ReisefΓΌhrer",
    live: "Live",
    exploreCards: {
      beaches: {
        title: "StrΓ¤nde auf Chios",
        text: "Klares Wasser, vulkanische Buchten und familienfreundliche StrΓ¤nde.",
      },
      villages: {
        title: "DΓ¶rfer auf Chios",
        text: "MastixdΓ¶rfer, mittelalterliche Gassen und lokales Leben.",
      },
      museums: {
        title: "Museen auf Chios",
        text: "Mastixkultur, Geschichte, BΓΌcher und maritimes Erbe.",
      },
    },
  },
  it: {
    ...
    openMenu: "Apri menu",
    rooms: "Camere",
    findYourRoom: "Trova la tua camera",
    rates: "Prezzi",
    ratesAvailability: "Prezzi & DisponibilitΓ ",
    deals: "Offerte",
    chiosIsland: "Isola di Chios",
    beaches: "Spiagge",
    villages: "Villaggi",
    museums: "Musei",
    chiosActivities: "AttivitΓ  a Chios",
    contact: "Contatti",
  ...
  es: {
    ariaMain: "NavegaciΓ³n principal",
    ...
    closeMenu: "Cerrar menΓΊ",
    openMenu: "Abrir menΓΊ",
    rooms: "Habitaciones",
    findYourRoom: "Encuentra tu habitaciΓ³n",
    rates: "Precios",
    ...
    villages: "Pueblos",
    museums: "Museos",
    chiosActivities: "Actividades en QuΓ­os",
    contact: "Contacto",
    chiosIslandGuide: "GuΓ­a de Chios",
    live: "Live",
    exploreCards: {
      beaches: {
        title: "Playas de Chios",
        text: "Aguas cristalinas, calas volcΓ΅nicas y playas familiares.",
      },
      villages: {
      ...
      museums: {
        ...
        text: "Cultura del mastiha, historia, libros y patrimonio marΓ­timo.",
      },
    },
  },
  tr: {
    ariaMain: "Ana gezinme",
    ariaLanguage: "Dil seΓ§ici",
    bookNow: "Rezervasyon",
    bookStay: "KonaklamanΔ±zΔ± ayΔ±rtΔ±n",
    menu: "MenΓΌ",
    exploreTitle: "Voulamandis House'u keΕfedin",
    language: "Dil",
    stay: "Konaklama",
    exploreChios: "SakΔ±z AdasΔ±'nΔ± keΕfedin",
    closeMenu: "MenΓΌyΓΌ kapat",
    openMenu: "MenΓΌyΓΌ aΓ§",
    rooms: "Odalar",
    findYourRoom: "OdanΔ± bul",
    rates: "Fiyatlar",
    ratesAvailability: "Fiyatlar & MΓΌsaitlik",
    deals: "FΔ±rsatlar",
    chiosIsland: "SakΔ±z AdasΔ±",
    beaches: "Plajlar",
    villages: "KΓ¶yler",
    museums: "MΓΌzeler",
    chiosActivities: "SakΔ±z AdasΔ± Aktiviteleri",
    contact: "Δ°letiΕim",
    chiosIslandGuide: "SakΔ±z AdasΔ± Rehberi",
    live: "Live",
    exploreCards: {
      beaches: {
        title: "SakΔ±z AdasΔ± PlajlarΔ±",
        text: "Berrak sular, volkanik koylar ve aile dostu plajlar.",
      },
      villages: {
        title: "SakΔ±z AdasΔ± KΓ¶yleri",
        text: "Mastik kΓ¶yleri, Orta Γ‡aΔ sokaklarΔ± ve yerel yaΕam.",
      },
      museums: {
        title: "SakΔ±z AdasΔ± MΓΌzeleri",
        text: "Mastik kΓΌltΓΌrΓΌ, tarih, kitaplar ve denizcilik mirasΔ±.",
      },
    },
  },
};
...
function getLanguageHref(path: string, language: LanguageCode) {
  ...
  const isFindYourRoomPage =
    Object.values(findYourRoomPaths).includes(normalizedPath);
  ...
  if (isFindYourRoomPage) {
    return findYourRoomPaths[language];
  }
