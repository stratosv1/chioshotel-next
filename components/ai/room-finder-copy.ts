...
export const ROOM_FINDER_COPY: Record<RoomFinderLanguage, RoomFinderCopy> = {
  ...
  fr: {
    ...
    online: "Disponibilité en direct",
    details: "Détails",
    select: "Choisir",
  ...
  it: {
    ...
    online: "Disponibilità in tempo reale",
    details: "Dettagli",
    select: "Seleziona",
