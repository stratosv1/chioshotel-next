...
export const ROOM_FINDER_TONE: Record<RoomFinderLanguage, RoomFinderTone> = {
  el: {
    ...
    invalidDate: "Βεβαίως 😊 Πότε θα θέλατε να κάνετε check-in;",
  ...
  en: {
    ...
    invalidDate: "Of course 😊 When would you like to check in?",
  ...
  de: {
    ...
    invalidDate: "Sehr gern 😊 Wann möchten Sie einchecken?",
  ...
  fr: {
    ...
    invalidDate: "Bien sûr 😊 Quand souhaitez-vous faire le check-in ?",
  ...
  it: {
    ...
    invalidDate: "Certamente 😊 Quando desiderate fare il check-in?",
  ...
  es: {
    ...
    invalidDate: "Por supuesto 😊 ¿Cuándo desean hacer el check-in?",
  ...
  tr: {
    ...
    invalidDate: "Elbette 😊 Ne zaman giriş yapmak istersiniz?",
