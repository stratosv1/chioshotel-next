...
for (const [lang, original, updated] of [
  ['el', 'direct: "Τιμή απευθείας"', 'direct: "Τιμή απευθείας", original: "Αρχική τιμή", amenities: "Παροχές", showAmenities: "Περισσότερα", hideAmenities: "Λιγότερα"'],
  ['en', 'direct: "Direct rate"', 'direct: "Direct rate", original: "Original price", amenities: "Amenities", showAmenities: "More", hideAmenities: "Less"'],
  ['fr', 'direct: "Tarif direct"', 'direct: "Tarif direct", original: "Prix initial", amenities: "Équipements", showAmenities: "Plus", hideAmenities: "Moins"'],
  ['de', 'direct: "Direktpreis"', 'direct: "Direktpreis", original: "Ursprünglicher Preis", amenities: "Ausstattung", showAmenities: "Mehr", hideAmenities: "Weniger"'],
  ['it', 'direct: "Tariffa diretta"', 'direct: "Tariffa diretta", original: "Prezzo iniziale", amenities: "Servizi", showAmenities: "Altro", hideAmenities: "Meno"'],
  ['es', 'direct: "Tarifa directa"', 'direct: "Tarifa directa", original: "Precio original", amenities: "Servicios", showAmenities: "Más", hideAmenities: "Menos"'],
  ['tr', 'direct: "Direkt fiyat"', 'direct: "Direkt fiyat", original: "İlk fiyat", amenities: "Olanaklar", showAmenities: "Daha fazla", hideAmenities: "Daha az"'],
]) {
