...
const preferredTitles = new Map([
  ...
  ["Hotel a Chios", "Camere e appartamenti a Chios | Kambos"],
  ["Offerte hotel a Chios 2026", "Offerte soggiorno a Chios | Tariffe dirette"],
  ["Sapori di Chios", "Sapori di Chios | Cucina e prodotti locali"],
  ["Musei di Chios", "Musei di Chios | Storia, cultura e mastice"],
  ["Chios per amanti del mare", "Chios per amanti del mare | Spiagge e calette"],
  ["Orchidee di Chios", "Orchidee di Chios | Specie e fioritura"],
  ["Camere e appartamenti a Chios", "Camere e appartamenti a Chios | Guida alle soluzioni"],
  ["Quiz vacanze a Chios 2026", "Quiz vacanze a Chios | Trova il soggiorno ideale"],
  ["Camera Doppia Economy a Chios", "Camera doppia Economy a Chios | Comfort e convenienza"],
  ["Villaggi di Chios", "Villaggi di Chios | Guida ai borghi più belli"],
  ["Prenota diretto a Chios", "Camere a Chios | Prenota direttamente"],
  ["Spiagge di Chios", "Spiagge di Chios | Guida alle baie più belle"],
  ["Vacanze in Famiglia a Chios", "Vacanze in famiglia a Chios | Guida pratica"],
  ["Villaggi del mastice a Chios", "Villaggi del mastice a Chios | Guida e itinerari"],
  ["Villaggi sul mare a Chios", "Villaggi sul mare a Chios | Guida e itinerari"],
  ["Spiagge attrezzate a Chios", "Spiagge attrezzate a Chios | Servizi e accesso"],
  ["Spiagge di sabbia a Chios", "Spiagge di sabbia a Chios | Guida completa"],
  ["Spiagge riparate a Chios", "Spiagge riparate a Chios | Mare calmo"],
  ["Villaggi medievali di Chios", "Villaggi medievali di Chios | Storia e castelli"],
  ["Guerra dei razzi di Chios", "Guerra dei razzi a Chios | Pasqua a Vrontados"],
  ["Trekking a Chios", "Trekking a Chios | Sentieri e itinerari"],
  ["Festival Mostra a Chios", "Festival Mostra a Chios | Tradizione di Carnevale"],
  ...
  ["Olympoi Chios", "Olympoi a Chios | Villaggio medievale del mastice"],
  ["Hotel en Chios", "Habitaciones y apartamentos en Quíos | Kambos"],
  ["Playas de Chios", "Playas de Quíos | Guía de las mejores playas"],
  ["Actividades en Quíos", "Actividades en Quíos | Qué hacer en la isla"],
  ["Pueblos de Chios", "Pueblos de Quíos | Guía de los más bonitos"],
  ["Orquídeas de Quíos", "Orquídeas de Quíos | Especies y floración"],
  ["Sabores de Quíos", "Sabores de Quíos | Cocina y productos locales"],
  ["Museos de Chios", "Museos de Quíos | Historia, cultura y mastique"],
  ["Reserva directa en Quíos", "Habitaciones en Quíos | Reserva directa"],
  ["Pueblos medievales de Chios", "Pueblos medievales de Quíos | Historia y castillos"],
  ["Lagada Chios", "Lagada en Quíos | Pueblo costero y tabernas"],
  ["Pueblos del mastiha en Chios", "Pueblos del mastique en Quíos | Guía y rutas"],
  ["Pueblos costeros de Chios", "Pueblos costeros de Quíos | Guía y rutas"],
  ["Festival Mostra en Quíos", "Festival Mostra en Quíos | Tradición de carnaval"],
  ["Guerra de cohetes de Quíos", "Guerra de cohetes en Quíos | Pascua en Vrontados"],
  ["Senderismo en Quíos", "Senderismo en Quíos | Rutas y senderos"],
  ["Playas de arena en Quíos", "Playas de arena en Quíos | Guía completa"],
  ["Playas organizadas en Quíos", "Playas organizadas en Quíos | Servicios y acceso"],
  ["Playas resguardadas en Quíos", "Playas resguardadas en Quíos | Aguas tranquilas"],
