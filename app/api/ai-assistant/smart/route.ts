...
const SCOPE_ONLY_COPY: Record<SupportedLanguage, string> = {
  el: "Μπορώ να βοηθήσω με το Voulamandis House, τα δωμάτια, τις παροχές, την τοποθεσία, τις πολιτικές, το πρωινό, τις τιμές και τη διαθεσιμότητα. Ρωτήστε με κάτι σχετικό με τη διαμονή σας.",
  en: "I can help with Voulamandis House, its rooms, amenities, location, policies, breakfast, prices and availability. Ask me anything related to your stay.",
  de: "Ich helfe Ihnen gern mit Informationen zum Voulamandis House, zu Zimmern, Ausstattung, Lage, Regeln, Frühstück, Preisen und Verfügbarkeit.",
  fr: "Je peux vous aider au sujet de Voulamandis House, des chambres, équipements, de l’emplacement, des conditions, du petit-déjeuner, des tarifs et disponibilités.",
  it: "Posso aiutarti con Voulamandis House, camere, servizi, posizione, condizioni, colazione, prezzi e disponibilità.",
  es: "Puedo ayudarle con Voulamandis House, sus habitaciones, servicios, ubicación, políticas, desayuno, precios y disponibilidad.",
  tr: "Voulamandis House, odalar, olanaklar, konum, kurallar, kahvaltı, fiyatlar ve müsaitlik hakkında yardımcı olabilirim.",
};
