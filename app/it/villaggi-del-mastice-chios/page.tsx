...
const data = getVillageCategoryPage("mastic", "it");
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: absoluteUrl(data.seo.canonicalPath), languages: villageCategoryAlternates.mastic },
};

export default function Page() {
  return <><JsonLd data={buildChiosVillagesSchema(data)} /><ChiosVillagesPageTailwind data={data} /></>;
}
