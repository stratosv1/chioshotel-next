...
export const SALES_KNOWLEDGE: KnowledgeItem[] = [
  ...
  },
  {
    ...
    kind: "room",
    title: "Ground-floor rooms 5, 6 and 7",
    summary: "Ground-floor rooms with no stairs and direct access to the courtyard or garden.",
    facts: [
      "Rooms 5, 6 and 7 are on the ground floor.",
    ...
    tags: ["ground floor", "no stairs", "room 5", "room 6", "room 7", "garden access", "three guests"],
    links: {
  ...
  },
  {
    ...
    facts: [
      ...
      "Room 1 has access to a shared terrace; room 4 has a private balcony.",
    ],
  ...
  },
  {
    ...
    summary: "Kontari Beach is the nearest beach, about 2.5 km from Voulamandis House; a car is recommended unless guests enjoy walking.",
    facts: [
      "Kontari Beach is approximately 2.5 km from the property.",
      "A car is recommended from Kambos unless the guest is comfortable with a longer walk.",
      "Reception can suggest the most suitable nearby option depending on wind, timing and the guest's preferred atmosphere.",
    ],
    tags: ["nearest beach", "kontari", "kontari beach", "2.5 km", "car recommended", "walking"],
