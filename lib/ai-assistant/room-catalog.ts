...
export const ASSISTANT_ROOMS: AssistantRoom[] = [
  { number: 1, roomId: "267788", unitId: "1", type: "standard", category: "Δίκλινο / Τρίκλινο", floor: "Πρώτος όροφος · 14 σκαλοπάτια", maxGuests: 4, beds: "1 διπλό κρεβάτι και 2 μονά κρεβάτια", features: ["Πρόσβαση σε κοινόχρηστη βεράντα", "Δύο χώροι χωρίς ενδιάμεση πόρτα", ...COMMON], image: "/images/rooms/DSC07776-2-e1675109942622.webp", priceRank: 5, detailsUrls: standardUrls, attributes: { firstFloor: true, familyFriendly: true } },
  ...
  { number: 8, roomId: "265595", unitId: "1", type: "family", category: "Ανεξάρτητο διαμέρισμα", floor: "Ισόγειο · 4–5 σκαλοπάτια", maxGuests: 4, beds: "1 διπλό κρεβάτι και 2 καναπέδες-κρεβάτια", features: ["Πλήρης κουζίνα", "Ξεχωριστό υπνοδωμάτιο με πόρτα", "Ιδιωτικό μπαλκόνι με θέα στο περιβόλι", ...COMMON], image: "/images/rooms/chios-apartments-voulamandis.webp", priceRank: 8, detailsUrls: familyUrls, attributes: { groundFloor: true, fullKitchen: true, familyFriendly: true } },
  { number: 9, roomId: "265595", unitId: "2", type: "family", category: "Ανεξάρτητο διαμέρισμα", floor: "Ισόγειο · 4–5 σκαλοπάτια", maxGuests: 4, beds: "1 διπλό κρεβάτι και 2 καναπέδες-κρεβάτια", features: ["Πλήρης κουζίνα", "Ξεχωριστό υπνοδωμάτιο με πόρτα", "Ιδιωτικό μπαλκόνι με θέα στο περιβόλι", ...COMMON], image: "/images/rooms/chios-apartments-voulamandis.webp", priceRank: 9, detailsUrls: familyUrls, attributes: { groundFloor: true, fullKitchen: true, familyFriendly: true } },
  { number: 10, roomId: "265595", unitId: "3", type: "family", category: "Ανεξάρτητο διαμέρισμα", floor: "Ισόγειο · 4–5 σκαλοπάτια", maxGuests: 5, beds: "1 διπλό κρεβάτι και 1 διπλός καναπές-κρεβάτι", features: ["Πλήρης κουζίνα", "Ξεχωριστό υπνοδωμάτιο με πόρτα", "Ιδιωτικό μπαλκόνι με θέα στο περιβόλι", ...COMMON], image: "/images/rooms/DSC07899.webp", priceRank: 10, detailsUrls: familyUrls, attributes: { groundFloor: true, fullKitchen: true, familyFriendly: true }, note: "Κανονική χωρητικότητα 4 άτομα. Ο 5ος φιλοξενείται μόνο κατόπιν συνεννόησης, με πρόσθετο μονό κρεβάτι στο υπνοδωμάτιο και περιορισμένο χώρο." },
];
