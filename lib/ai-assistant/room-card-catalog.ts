...
export const ROOM_CARD_CATALOG: RoomCardCatalogEntry[] = [
  ...
  },
  {
    ...
    copy: {
      el: { name: "Διαμέρισμα 8", category: "Οικογενειακό διαμέρισμα", floor: "Ισόγειο · χωρίς σκαλοπάτια", features: ["Πλήρης κουζίνα", "1 διπλό και 2 καναπέδες-κρεβάτια", "Ιδιωτικό μπαλκόνι με θέα στο περιβόλι", "Κλιματισμός"] },
      en: { name: "Apartment 8", category: "Family apartment", floor: "Ground floor · step-free access", features: ["Full kitchen", "1 double and 2 sofa beds", "Private balcony with orchard view", "Air conditioning"] },
      de: { name: "Apartment 8", category: "Familienapartment", floor: "Erdgeschoss · stufenloser Zugang", features: ["Voll ausgestattete Küche", "1 Doppelbett und 2 Schlafsofas", "Privatbalkon mit Obstgartenblick", "Klimaanlage"] },
      fr: { name: "Appartement 8", category: "Appartement familial", floor: "Rez-de-chaussée · accès sans marches", features: ["Cuisine complète", "1 lit double et 2 canapés-lits", "Balcon privé sur le verger", "Climatisation"] },
      it: { name: "Appartamento 8", category: "Appartamento familiare", floor: "Piano terra · accesso senza gradini", features: ["Cucina completa", "1 matrimoniale e 2 divani letto", "Balcone privato sul frutteto", "Aria condizionata"] },
      es: { name: "Apartamento 8", category: "Apartamento familiar", floor: "Planta baja · acceso sin escalones", features: ["Cocina completa", "1 cama doble y 2 sofás cama", "Balcón privado al huerto", "Aire acondicionado"] },
      tr: { name: "Daire 8", category: "Aile dairesi", floor: "Zemin kat · basamaksız erişim", features: ["Tam donanımlı mutfak", "1 çift yatak ve 2 çekyat", "Meyve bahçesi manzaralı özel balkon", "Klima"] },
    },
  },
  {
    ...
    detailsUrl: familyDetails,
    copy: {
      el: { name: "Διαμέρισμα 9", category: "Οικογενειακό διαμέρισμα", floor: "Ισόγειο · χωρίς σκαλοπάτια", features: ["Πλήρης κουζίνα", "1 διπλό και 2 καναπέδες-κρεβάτια", "Ιδιωτικό μπαλκόνι με θέα στο περιβόλι", "Κλιματισμός"] },
      en: { name: "Apartment 9", category: "Family apartment", floor: "Ground floor · step-free access", features: ["Full kitchen", "1 double and 2 sofa beds", "Private balcony with orchard view", "Air conditioning"] },
      de: { name: "Apartment 9", category: "Familienapartment", floor: "Erdgeschoss · stufenloser Zugang", features: ["Voll ausgestattete Küche", "1 Doppelbett und 2 Schlafsofas", "Privatbalkon mit Obstgartenblick", "Klimaanlage"] },
      fr: { name: "Appartement 9", category: "Appartement familial", floor: "Rez-de-chaussée · accès sans marches", features: ["Cuisine complète", "1 lit double et 2 canapés-lits", "Balcon privé sur le verger", "Climatisation"] },
      it: { name: "Appartamento 9", category: "Appartamento familiare", floor: "Piano terra · accesso senza gradini", features: ["Cucina completa", "1 matrimoniale e 2 divani letto", "Balcone privato sul frutteto", "Aria condizionata"] },
      es: { name: "Apartamento 9", category: "Apartamento familiar", floor: "Planta baja · acceso sin escalones", features: ["Cocina completa", "1 cama doble y 2 sofás cama", "Balcón privado al huerto", "Aire acondicionado"] },
      tr: { name: "Daire 9", category: "Aile dairesi", floor: "Zemin kat · basamaksız erişim", features: ["Tam donanımlı mutfak", "1 çift yatak ve 2 çekyat", "Meyve bahçesi manzaralı özel balkon", "Klima"] },
    },
  },
  {
    ...
    detailsUrl: familyDetails,
    copy: {
      el: { name: "Διαμέρισμα 10", category: "Μεγάλο οικογενειακό διαμέρισμα", floor: "Ισόγειο · χωρίς σκαλοπάτια", features: ["Πλήρης κουζίνα", "1 διπλό και 1 διπλός καναπές-κρεβάτι", "Κανονικά έως 4 άτομα", "Κλιματισμός"] },
      en: { name: "Apartment 10", category: "Large family apartment", floor: "Ground floor · step-free access", features: ["Full kitchen", "1 double bed and 1 double sofa bed", "Regular capacity: 4 guests", "Air conditioning"] },
      de: { name: "Apartment 10", category: "Großes Familienapartment", floor: "Erdgeschoss · stufenloser Zugang", features: ["Voll ausgestattete Küche", "1 Doppelbett und 1 Doppelschlafsofa", "Reguläre Belegung: 4 Gäste", "Klimaanlage"] },
      fr: { name: "Appartement 10", category: "Grand appartement familial", floor: "Rez-de-chaussée · accès sans marches", features: ["Cuisine complète", "1 lit double et 1 canapé-lit double", "Capacité normale : 4 personnes", "Climatisation"] },
      it: { name: "Appartamento 10", category: "Grande appartamento familiare", floor: "Piano terra · accesso senza gradini", features: ["Cucina completa", "1 matrimoniale e 1 divano letto doppio", "Capienza normale: 4 ospiti", "Aria condizionata"] },
      es: { name: "Apartamento 10", category: "Apartamento familiar grande", floor: "Planta baja · acceso sin escalones", features: ["Cocina completa", "1 cama doble y 1 sofá cama doble", "Capacidad normal: 4 huéspedes", "Aire acondicionado"] },
      tr: { name: "Daire 10", category: "Büyük aile dairesi", floor: "Zemin kat · basamaksız erişim", features: ["Tam donanımlı mutfak", "1 çift kişilik yatak ve 1 çift kişilik çekyat", "Normal kapasite: 4 kişi", "Klima"] },
    },
  },
];
