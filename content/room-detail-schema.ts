...
const roomSchemaTerms: Record<string, RoomSchemaDictionary> = {
  ...
  "1 double sofa bed": { el: "1 διπλός καναπές-κρεβάτι", fr: "1 canapé-lit double", de: "1 Doppelschlafsofa", it: "1 divano letto matrimoniale", es: "1 sofá cama doble", tr: "1 çift kişilik çekyat" },
  "Room 6 is ideal for guests who love nature. Located on the ground floor, it opens directly to the peaceful courtyard and garden.": { fr: "La chambre 6 est au rez-de-chaussée et s’ouvre directement sur la cour paisible et le jardin.", it: "La camera 6 è al piano terra e si apre direttamente sul cortile tranquillo e sul giardino.", tr: "Oda 6 zemin kattadır ve huzurlu avlu ile bahçeye doğrudan açılır.", es: "La habitación 6 está en planta baja y se abre directamente al tranquilo patio y al jardín."},
  "Room 2 is located on the first floor and offers access to a shared terrace with views over the estate and the citrus trees of Kambos.": { fr: "La chambre 2 se trouve au premier étage et donne accès à une terrasse partagée avec vue sur le domaine et les agrumes de Kambos.", it: "La camera 2 si trova al primo piano e offre accesso a una terrazza condivisa con vista sulla tenuta e sugli agrumeti di Kambos.", tr: "Oda 2 üst katta yer alır ve narenciye bahçelerine bakan ortak terasa erişim sunar.", es: "La habitación 2 está en la primera planta y ofrece acceso a una terraza compartida con vistas a la finca y a los cítricos de Kambos."},
  "Room 5 is a ground-floor double / triple room with direct courtyard and garden access. It is ideal for guests who prefer no stairs and an easy outdoor connection.": { fr: "La chambre 5 est une chambre double / triple au rez-de-chaussée avec accès direct à la cour et au jardin, idéale si vous préférez éviter les escaliers.", it: "La camera 5 è una doppia / tripla al piano terra con accesso diretto al cortile e al giardino, ideale per chi preferisce evitare le scale.", tr: "Oda 5, avlu ve bahçeye doğrudan erişimi olan zemin kat çift / üç kişilik odadır.", es: "La habitación 5 es una doble / triple en planta baja con acceso directo al patio y al jardín, ideal para quienes prefieren evitar las escaleras."},
  "Room 7 is a ground-floor double / triple room with garden access and a flexible layout with a sofa bed.": { fr: "La chambre 7 est une chambre double / triple au rez-de-chaussée avec accès au jardin et un agencement flexible avec canapé-lit.", it: "La camera 7 è una doppia / tripla al piano terra con accesso al giardino e una disposizione flessibile con divano letto.", tr: "Oda 7, bahçe erişimi ve çekyatlı zemin kat çift / üç kişilik odadır.", es: "La habitación 7 es una doble / triple en planta baja con acceso al jardín y una distribución flexible con sofá cama."},
  "Room 1 is a first-floor room for up to 4 guests, with upper-floor view, private balcony feel and two sleeping spaces without a connecting door.": { fr: "La chambre 1 se trouve au premier étage et accueille jusqu’à 4 personnes, avec vue depuis l’étage, ambiance de balcon privé et deux espaces de couchage sans porte communicante.", it: "La camera 1 si trova al primo piano e ospita fino a 4 persone, con vista dal piano superiore e due zone notte senza porta comunicante.", tr: "Oda 1 üst katta yer alır ve iki uyku alanıyla 4 kişiye kadar konaklama sunar.", es: "La habitación 1 está en la primera planta y aloja hasta 4 personas, con vistas desde la planta superior y dos zonas de descanso sin puerta comunicante."},
  "Room 3 is a first-floor double / triple room with kitchenette, upper-floor view and access by stairs.": { fr: "La chambre 3 est une chambre double / triple au premier étage avec kitchenette, vue depuis l’étage et accès par escalier.", it: "La camera 3 è una doppia / tripla al primo piano con angolo cottura, vista dal piano superiore e accesso tramite scale.", tr: "Oda 3, mini mutfak ve merdiven erişimi olan üst kat çift / üç kişilik odadır.", es: "La habitación 3 es una doble / triple en primera planta con cocina pequeña, vistas desde la planta superior y acceso por escaleras."},
  "Room 4 is a first-floor double / triple room with kitchenette, sofa bed and upper-floor view.": { fr: "La chambre 4 est une chambre double / triple au premier étage avec kitchenette, canapé-lit et vue depuis l’étage.", it: "La camera 4 è una doppia / tripla al primo piano con angolo cottura, divano letto e vista dal piano superiore.", tr: "Oda 4, mini mutfak, çekyat ve üst kat manzarası sunan çift / üç kişilik odadır.", es: "La habitación 4 es una doble / triple en primera planta con cocina pequeña, sofá cama y vistas desde la planta superior."},
  "Apartment 8 is a family apartment with living room and kitchen, separate bedroom and bathroom. It is suitable for up to 4 guests.": { fr: "L’appartement 8 est un appartement familial avec salon et cuisine, chambre séparée et salle de bain, adapté à un séjour jusqu’à 4 personnes.", it: "L’appartamento 8 è una soluzione familiare con soggiorno e cucina, camera separata e bagno, adatta fino a 4 ospiti.", tr: "Daire 8, mutfaklı oturma alanı, ayrı yatak odası ve banyoya sahiptir; 4 kişiye kadar uygundur.", es: "El apartamento 8 es un apartamento familiar con sala de estar y cocina, dormitorio independiente y baño, adecuado para hasta 4 huéspedes."},
  "Apartment 9 offers the same family-friendly layout with kitchen, living area, bedroom and bathroom, suitable for up to 4 guests.": { fr: "L’appartement 9 offre un agencement adapté aux familles avec cuisine, salon, chambre et salle de bain, pour jusqu’à 4 personnes.", it: "L’appartamento 9 offre una disposizione adatta alle famiglie con cucina, soggiorno, camera e bagno, fino a 4 ospiti.", tr: "Daire 9, mutfak, oturma alanı, yatak odası ve banyodan oluşan aile dostu bir düzene sahiptir; 4 kişiye kadar uygundur.", es: "El apartamento 9 ofrece una distribución familiar con cocina, sala de estar, dormitorio y baño, adecuada para hasta 4 huéspedes."},
  "Apartment 10 is a family apartment with living room and kitchen, bedroom and flexible sofa-bed layout.": { fr: "L’appartement 10 est un appartement familial avec salon et cuisine, chambre et agencement flexible avec canapés-lits.", it: "L’appartamento 10 è una soluzione familiare con soggiorno e cucina, camera e una disposizione flessibile con divani letto.", tr: "Daire 10, mutfaklı oturma alanı, yatak odası ve esnek çekyat düzenine sahip bir aile dairesidir.", es: "El apartamento 10 es un apartamento familiar con sala de estar y cocina, dormitorio y una distribución flexible con sofás cama."},
};
