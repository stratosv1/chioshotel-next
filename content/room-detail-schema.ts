...
const roomSchemaTerms: Record<string, RoomSchemaDictionary> = {
  ...
  "Room 6 is ideal for guests who love nature. Located on the ground floor, it opens directly to the peaceful courtyard and garden.": { fr: "La chambre 6 est au rez-de-chaussée et s’ouvre directement sur la cour paisible et le jardin.", tr: "Oda 6 zemin kattadır ve huzurlu avlu ile bahçeye doğrudan açılır." },
  ...
  "Room 7 is a ground-floor double / triple room with garden access and a flexible layout with a sofa bed.": { fr: "La chambre 7 est une chambre double / triple au rez-de-chaussée avec accès au jardin et un agencement flexible avec canapé-lit.", tr: "Oda 7, bahçe erişimi ve çekyatlı zemin kat çift / üç kişilik odadır." },
  ...
  "Room 3 is a first-floor double / triple room with kitchenette, upper-floor view and access by stairs.": { fr: "La chambre 3 est une chambre double / triple au premier étage avec kitchenette, vue depuis l’étage et accès par escalier.", tr: "Oda 3, mini mutfak ve merdiven erişimi olan üst kat çift / üç kişilik odadır." },
  "Room 4 is a first-floor double / triple room with kitchenette, sofa bed and upper-floor view.": { fr: "La chambre 4 est une chambre double / triple au premier étage avec kitchenette, canapé-lit et vue depuis l’étage.", tr: "Oda 4, mini mutfak, çekyat ve üst kat manzarası sunan çift / üç kişilik odadır." },
  ...
  "Apartment 10 is a family apartment with living room and kitchen, bedroom and flexible sofa-bed layout.": { fr: "L’appartement 10 est un appartement familial avec salon et cuisine, chambre et agencement flexible avec canapés-lits.", tr: "Daire 10, mutfaklı oturma alanı, yatak odası ve esnek çekyat düzenine sahip bir aile dairesidir." },
};
