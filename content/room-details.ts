  ...
  individualRooms: {
    ...
    rooms: [
      ...
      },
      {
        ...
        maxGuests: 4,
        description:
          "Room 1 is approximately 30–35 m² and sleeps up to 4 guests in 1 double and 2 single beds. It has two open connected spaces without an internal door and access to a shared terrace.",
        badges: ["First floor", "14 stairs", "Shared terrace", "Up to 4 guests"],
        beds: ["1 double bed", "2 single beds"],
        amenities: [
          { icon: "📶", label: "Wi-Fi" },
          { icon: "☕", label: "Coffee and tea kettle" },
          { icon: "🌤️", label: "Shared terrace" },
          { icon: "🌾", label: "Upper-floor view" },
          { icon: "🪜", label: "14 stairs" },
  ...
  individualRooms: {
    ...
    rooms: [
      ...
      },
      {
        ...
        name: "Δωμάτιο 1",
        type: "Δίκλινο / Τρίκλινο",
        location: "Πρώτος όροφος",
        description:
          "Το Δωμάτιο 1 είναι περίπου 30–35 τ.μ. και φιλοξενεί έως 4 άτομα σε 1 διπλό και 2 μονά κρεβάτια. Έχει δύο ξεχωριστούς χώρους χωρίς πόρτα και πρόσβαση σε κοινόχρηστη βεράντα.",
        badges: ["Πρώτος όροφος", "14 σκαλοπάτια", "Κοινόχρηστη βεράντα", "Έως 4 άτομα"],
